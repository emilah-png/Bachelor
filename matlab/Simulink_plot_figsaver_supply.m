...
Main.Vref    = Data.data{13}.Values.Data;
Main.Vreal   = Data.data{31}.Values.Data;
% Main.FF      = Data.data{12}.Values.Data;
% Main.PID     = Data.data{15}.Values.Data;
% Main.U       = Data.data{17}.Values.Data;
...
Jib.Vref     = Data.data{5}.Values.Data;
Jib.Vreal    = Data.data{25}.Values.Data;
...
saveas(Main_pressure,EPS_path+file+'_Main_pressure','epsc') 
% 
% % Control Signal
...
% 
% Velocity
saveas(Main_velocity,PNG_path+file+'_Main_velocity.png')
saveas(Main_velocity,EPS_path+file+'_Main_velocity','epsc') 
...
saveas(Jib_pressure,EPS_path+file+'_Jib_pressure','epsc') 
% 
% % Control Signal
...
saveas(Jib_velocity,EPS_path+file+'_Jib_velocity','epsc') 
