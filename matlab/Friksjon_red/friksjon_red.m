...
Pa_jib_data = data{3}.extractTimetable;
Pb_jib_data = data{5}.extractTimetable;
X_jib_data = data{7}.extractTimetable;
...
Pa_jib_bar = Pa_jib_data.("<fFilteredSignal_G_OPCfJibPaCylfFilteredSignal>"); %Bar
Pb_jib_bar = Pb_jib_data.("<fFilteredSignal_G_OPCfJibPbCylfFilteredSignal>") ; %Bar
X_jib = X_jib_data.("<fFilteredSignal_G_OPCfJibPistonPositionfFilteredSignal>") ; %m
...
dC_jib = 0.065; %Piston diameter
dRC_jib = 0.035; %Rod diameter
