...
declare namespace EcDiagnostics.Commons {
    ...
    abstract class Communication {
        ...
        protected __subscribe(id: number, subscriptionCb: EcDiagnostics.Commons.SubscriptionCallback): void;
        /** key is the subscription id */
        protected __callbacks: Map<number, EcDiagnostics.Commons.SubscriptionCallback>;
        /** value is the subscription id */
        protected __unsubscribeInProgress: Set<number>;
        protected __unsubscribe(subscriptionId: number): void;
        protected __unsubscribedSuccessfully(subscriptionId: number): void;
