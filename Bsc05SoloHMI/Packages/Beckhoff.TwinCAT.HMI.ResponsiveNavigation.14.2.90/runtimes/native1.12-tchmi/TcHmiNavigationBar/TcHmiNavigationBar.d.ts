declare namespace TcHmi.Controls.ResponsiveNavigation {
    class TcHmiNavigationBar extends TcHmi.Controls.System.TcHmiControl {
        ...
        protected __eventList: Map<HTMLElement, Map<string, (e: Event) => void>>;
        protected __menuSourceData: TcHmiNavigation.MenuItem[] | undefined;
        protected __menuSourceDataRaw: TcHmiNavigation.MenuItem[] | null | undefined;
         ...
         */
        protected __addEvent(element: HTMLElement, event: keyof GlobalEventHandlersEventMap, callback: (e: Event) => void): void;
        /**
        ...
        protected __onResolverForMenuSourceDataCallback: (data: Symbol.ObjectResolver.IWatchResultObject<TcHmiNavigation.MenuItem[]>) => void;
         ...
         */
        setNavContentControl(valueNew: ResponsiveNavigation.TcHmiNavigationContent | null): void;
        /**
         * DEPRECATED
